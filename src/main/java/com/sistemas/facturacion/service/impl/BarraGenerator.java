...
import com.sistemas.facturacion.model.CUIT;
import com.sistemas.facturacion.model.Comprobantes;
...
public class BarraGenerator implements Serializable, Cloneable, Transferable {
    ...
    private Comprobantes tipoComprobante;
    ...
    public Comprobantes getTipoComprobante() {
        return tipoComprobante;
    }

    public void setTipoComprobante(Comprobantes tipoComprobante) {
        Comprobantes t = this.tipoComprobante;
    ...
    public Object clone() {
        try {
            BarraGenerator b = (BarraGenerator) super.clone();
    ...
    public Object getTransferData(DataFlavor flavor) throws UnsupportedFlavorException, IOException {
        if (flavor.equals(DataFlavor.imageFlavor)) {
            BufferedImage i = dameImagen("1",1,1,"","");
            return i;
        }
        throw new UnsupportedFlavorException(flavor);
    }

    BufferedImage dameImagen(CharSequence cuit, long cae, int ptovta, String fecha, String tipoComp) {
        this.cai = cae;
        this.cuit = new CUIT(cuit);
        this.puntoDeVenta = ptovta;
        this.vencimiento = new Date();
        this.tipoComprobante = Comprobantes.FACTURAS_B;
        int w = 605;
        int h = 80;
